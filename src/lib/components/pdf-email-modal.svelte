<script lang="ts">
	...
	// Derived subject and message
	const subject = $derived(`Medical Referral for ${student.firstName} ${student.lastName}`);
	const message = $derived(`Dear Medical Professional,
