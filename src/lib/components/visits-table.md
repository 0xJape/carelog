...
A reusable component for displaying clinic visit records with consistent styling and functionality across the CLINIQAI application.
...
- **Consistent Styling**: Matches the CLINIQAI design system
