...
<svelte:head>
	<title>Setup Admin Account - CLINIQAI</title>
	<meta
		name="description"
		content="Create your administrator account to get started with CLINIQAI"
	/>
</svelte:head>
	...
	<div class="w-full max-w-md space-y-6">
		...
		<div class="space-y-2 text-center">
			...
			<p class="text-xs text-gray-400 dark:text-gray-500">
				CLINIQAI v1.0 - School Clinic Management System
			</p>
		</div>
	</div>
</div>
