...
export const load: PageServerLoad = async () => {
	// Initialization route disabled — admin already created.
	// Redirect to login to avoid exposing setup in production.
...
export const actions: Actions = {
	createAdmin: async (event) => {
		...
		// Redirect outside try-catch so it doesn't get caught as an error
		return redirect(302, '/');
	}
};
